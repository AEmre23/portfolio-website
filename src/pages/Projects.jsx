  ...
  >
    ...
    >
      ...
      <div className="w-screen text-white text-center space-y-4 pb-12 justify-center flex flex-col items-center gap-12">
        ...
        <div onClick={()=> setScreen("contact")} className="hover:bg-gray-100 font-bold bg-neutral-900 duration-300 hover:text-black text-2xl cursor-pointer p-3 border-2 border-yellow-50 text-yellow-100 rounded-lg w-64">
          {t('Project-8')}
        </div>
      </div>
