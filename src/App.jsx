...
function App() {
  ...
  return (
    <AnimatePresence>
      ...
      {screen === "welcome" && <Welcome setScreen={setScreen} key={screen} />}
      {screen === "hero" && (
        <Hero
          key={screen}
          setScreen={setScreen}
      ...
      {screen === "about" && <About setScreen={setScreen} key={screen} />}
      {screen === "contact" && <Contact setScreen={setScreen} key={screen} />}
      {screen === "projects" && <Projects setScreen={setScreen} key={screen} />}
    </AnimatePresence>
  );
}
export default App;
