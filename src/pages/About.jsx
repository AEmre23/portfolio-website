...
const About = ({ setScreen }) => {
  ...
  // Display the duration on your site
  let durationText;
  if (i18next.language === "tr") {
    durationText = `${diffInYears} yıl, ${diffInRemainingMonths} aydır frontend geliştirici olarak çalışıyorum.`;
  } else {
      ...
      <m.div className="w-8/12 max-w-[1025px] m:w-11/12 space-y-12">
        ...
        >
          ...
          <div className="space-y-3 m:text-center">
            ...
            <div className="text-2xl">{durationText}</div>
          </div>
        </m.div>
        <m.div
          style={{
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="relative">
                <a
                  ...
                  className=""
                >
                  <span className="text-yellow-100 hover:underline">
                    grayCat
                  </span>
                </a>
                <div className="absolute -bottom-6 text-xs whitespace-nowrap">
                  Frontend Developer{" "}
                  <span className="font-bold text-yellow-300">|</span>{" "}
                  {t("About-2-3")} 2022 - {t("About-2-2")} 2022
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 flex flex-col self-start">
            <div className="flex gap-4 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 text-xs whitespace-nowrap">
                  {t("About-4-3")}{" "}
                  <span className="font-bold text-yellow-300">|</span> 2016 -
                  2021{" "}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 text-xs whitespace-nowrap">
                  {t("About-4-5")}{" "}
                  <span className="font-bold text-yellow-300">|</span> 2018 -
                  2020{" "}
                </div>
              </div>
            </div>
